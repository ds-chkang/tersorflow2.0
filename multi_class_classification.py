# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 19:42:07 2022
...
for class_idx in range(n_class):
    ...
    y_data = np.vstack((y_data, class_y_data)).astype(np.float32)
...
def training_reporter():
    ...
    print(template.format(train_loss_result(), train_acc_result()*100))
    
    train_loss.reset_states()
    train_acc_reset_states()
...
x1_test, x2_test  = X1.flattern(), X2.flatten()
